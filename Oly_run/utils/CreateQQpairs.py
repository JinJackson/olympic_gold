...
def getAllDatas(data_path):
    datasets = []
    with open('../../Olympic/data/all_result.json', 'r', encoding='utf8') as reader:
...
data_path = '../../Olympic/data/all_result.json'
...
pos = 0
neg = 0
with open('../../Olympic/data/QApairs.txt', 'w', encoding='utf-8') as writer:
