...
def generateData(QApairsData):
    ...
    with open('../../Olympic/data/all_data.txt', 'w', encoding='utf-8') as writer:
        print('writing')
...
def splitDataset():
    dataset = []
    with open('../../Olympic/data/all_data.txt', 'r', encoding='utf-8') as reader:
    ...
    with open('../../Olympic/data/train.txt', 'w', encoding='utf-8') as writer:
        writer.writelines(train_data)

    with open('../../Olympic/data/test.txt', 'w', encoding='utf-8') as writer:
