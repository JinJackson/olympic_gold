#--do_train --bert_model  "bert-base-chinese" --model_type "MatchModel" --train_file "data/finetune/finetune2/train2.txt" --test_file "data/finetune/finetune2/test2.txt" --do_lower_case --learning_rate 1e-5 --gpu 0 --epochs 12 --batch_size 4 --s1_length 50 --s2_length 50 --seed 1024 --save_dir "result_Olympic/model"
...
from dataset.dataset_Olym import TrainDataBert, EvalDataBert
